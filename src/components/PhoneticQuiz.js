...
export default function PhoneticQuiz({ lesson = {} }) {
  const { id, words = [], type } = lesson;
  ...
  if (type !== "phonetics" || !Array.isArray(words) || words.length === 0) {
    return <p className="text-center text-gray-500">Invalid lesson data.</p>;
  }
  ...
  return (
    <div className=" bg-blue-50 flex p-4">
      <div className=" space-y-4">
        ...
        <p className="text-center text-gray-700">Say the sentence aloud:</p>

        <div className="text-center text-xl font-semibold text-blue-700 flex items-center justify-center gap-2">
          {currentWord}
          <button
            onClick={readAloud}
