...
export default function Addition({ lesson = {} }) {
  ...
  const generateQuestion = () => {
    ...
    setQuestion({
      stem: `What is the sum of ${num1} and ${num2}?`,
      number: `${num1} + ${num2} = `,
      correctAnswer,
      options,
    });
  ...
  const handleInputBlur = () => {
    // setTimeout(() => setIsKeypadVisible(false), 200);
  };

  return (
    <div className="min-h-screen bg-gradient-to-br flex p-4">
      <div className="bg-white rounded-2xl p-8 w-full  flex flex-col items-left">
        ...
        {question && (
          <>
            ...
            <div className="flex flex-col mb-4">
              <p className="text-2xl ml-3 font-semibold text-gray-700">
                {" "}
                {number1}
              </p>
              <p className="text-2xl font-semibold text-gray-700">+{number2}</p>
