    ...
    <div className="min-h-screen bg-gray-100 p-4">
      ...
      <div className="flex justify-around gap-8">
        ...
        >
          ...
          <div className="grid grid-cols-5 gap-2 mb-4 sm:grid-cols-5 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-10">
        ...
        <div className="bg-white p-4 rounded shadow-md w-full max-w-sm">
          <h2 className="text-xl font-bold mb-2">Right Side</h2>
          <p className="text-gray-600 mb-4">Count: {rightItems.length}</p>
          <div className="grid grid-cols-5 gap-2 mb-4 sm:grid-cols-5 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-10">
